...
function promptContract(): JsonObject {
  return {
    ...
    visualProofCommand: "From the STAX checkout/tooling repo: npm run stax:collect-visual -- --repo <repo> --url <local-preview-url> --description <what was verified> --checklist <target page/state> --checklist <responsive/viewport checked> --checklist <visible outcome>; or use --path <screenshot.png> to register an existing image",
    reportSections: [
