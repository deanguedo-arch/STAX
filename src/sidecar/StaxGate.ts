...
import { STAX_PROOF_REPORT_RELATIVE_PATH } from "./AttachStax.js";
...
function renderProofStrength(proofStrength?: ProofStrengthResult): string[] {
  ...
  return [
    ...
    `- Report: ${STAX_PROOF_REPORT_RELATIVE_PATH}`
  ];
}

async function writeCodexReportProofStrengthSection(repoPath: string, proofStrength: ProofStrengthResult): Promise<void> {
