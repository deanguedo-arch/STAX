...
npm run pr-artifact:live-trial:hard:refresh:force-live
...
- `artifacts/pr_artifact_live_trial_hard.json`
- `artifacts/pr_artifact_live_trial_hard.md`
...
- 100-case hard live PR trial: 100 live-source / 0 fallback, false accepts 0, false blocks 0.
...
- Tagged as a clean RC4 proof pack.
