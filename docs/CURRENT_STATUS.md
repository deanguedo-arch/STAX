...
STAX is strong for Codex/repo project-control:

- fake-complete detection
- wrong-repo proof rejection
- scope policing
- bounded Codex handoffs
- proof-boundary enforcement
- sidecar gate / next-prompt workflow
...
- stax:status
- stax:next-prompt
- stax:preflight, if present

## Current Proof

- scoped 9.5 promotion ready
- investor proof: STAX 7, ChatGPT 0, ties 3
...
- latest restart baseline: `6eeff27`, with `staxcore-strict` success at run `26597243388`
