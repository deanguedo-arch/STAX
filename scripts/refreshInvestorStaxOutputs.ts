...
import { phaseBWorkspaceRepoPath } from "../src/campaign/PhaseBStatefulBenchmark.js";
import {
...
async function resolveWorkspace(workspaceName: string): Promise<{
  workspace?: string;
...
async function main(): Promise<void> {
  ...
  for (const capture of captures) {
    const resolved = await resolveWorkspace(capture.workspace);
